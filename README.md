...
a business cycle usually has business cycle at a lower period at 1.5 years and a
higher period at 8 years. This information can be used while for filtering as
expressed from the following Table [1](#ref-table1).

business data with recurring periods between 1.5 and 8 years to be business-cycle fluctuations
...
expressed using higher frequency as fragment of $\pi$ equal equal to 1
