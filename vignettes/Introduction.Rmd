---
title: "Introduction to CorbaeOuliaris"
...
vignette: >
  ...
  %\VignetteIndexEntry{Introduction to CorbaeOuliaris}
...
<p align="center">
    <img src="figure1.png" alt="Fig1" width="75%"/>
</p>
...
<p align="center">
    <img src="figure2.png" alt="Fig2" width="75%"/>
</p>
<p class="caption" align="center">
<span id="ref-Figure1"></span>Fig. 2: Corbae-Ouliaris FD Filter cycles.
</p>

Alternatively, instead of the fragment of $pi$ the periods could be use,
resulting into the same output:

```r
all.equal(co, corbae_ouliaris(USgdp, low_freq = 6, high_freq = 32))
```
```
## [1] TRUE
```
...
<p align="center">
    <img src="figure3.png" alt="Fig3" width="75%"/>
</p>
<p class="caption" align="center">
